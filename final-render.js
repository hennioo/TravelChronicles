        ...
        <div class="form-container">
          ...
          <form id="locationForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="latitude" name="latitude" required placeholder="z.B. 41.3851">
            </div>
            
            <div class="form-group">
              <label for="longitude">Längengrad*</label>
              <input type="text" id="longitude" name="longitude" required placeholder="z.B. 2.1734">
            </div>
