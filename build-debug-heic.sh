...
# Build-Skript mit erweitertem Debugging
echo "Starte Build mit verbessertem Debugging und HEIC-Unterstützung..."

# NPM-Pakete installieren (einschließlich heic-convert)
...
cp debug-heic-support.cjs dist/index.js
