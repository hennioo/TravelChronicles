// Ultra-vereinfachte Version für Render
...
// ULTRA-EINFACHE KARTE OHNE LEAFLET
      ...
      if (locations.length === 0) {
        ...
        for (const loc of locations) {
          ...
          if (loc.image) {
            ...
            imageHtml = `<img src="${imagePath}" alt="${loc.name}" style="max-width:100%; height:auto; margin-top:10px; border-radius:5px;">`;
          }
