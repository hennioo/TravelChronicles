...
# Build-Skript mit breiteren Rändern und verbessertem Design
echo "Starte Build mit breiteren Rändern und verbessertem Design..."
...
cp final-map-better-margins.cjs dist/index.js
