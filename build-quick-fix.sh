...
# Build-Skript für die einfache Fix-Version
echo "Starte Build mit schnellerer Fix-Version..."
...
cp quick-fix-server.js dist/index.js
...
cat > dist/package.json << EOL
{
  ...
  "version": "1.0.0",
  "description": "Travel Map Application with Fixed API Authentication",
  "main": "index.js",
  "type": "commonjs",
  "scripts": {
