// Einfache und robuste Serververbesserung
    ...
    <body>
      ...
      <script>
        ...
        function handleFormSubmit(e) {
          ...
          // WICHTIG: Direkt die Session-ID zum FormData hinzufügen
          formData.append('sessionId', currentSessionId);
          
          // URL mit Session-ID Parameter
          const url = '/api/locations?sessionId=' + currentSessionId;
          
          debug('Sende Daten an ' + url);
          ...
          .then(response => {
            ...
            // Überprüfen, ob wir HTML oder JSON bekommen
