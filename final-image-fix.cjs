// Final Fix mit Bildupload-Fehlerbehandlung und Logging
          ...
          <div class="form-container" id="addLocationForm">
            ...
            <form id="locationForm">
              ...
              <div class="form-group">
                ...
                <small style="color: #999; display: block; margin-top: 5px;">Unterstützte Formate: JPG, PNG, HEIC. Max. 20MB.</small>
              </div>
      ...
      <script>
        ...
        function validateImageFile(file) {
          ...
          if (!allowedTypes.includes(file.type) && !file.name.toLowerCase().endsWith('.heic')) {
            return {
              valid: false,
              message: 'Unerlaubter Dateityp. Nur JPG, PNG und HEIC sind erlaubt'
            };
          }
...
const upload = multer({
  ...
  fileFilter: (req, file, cb) => {
    ...
    if (isAllowed) {
      ...
      cb(new Error('Ungültiger Dateityp. Nur JPG, PNG und HEIC erlaubt.'), false);
    }
  }
});
