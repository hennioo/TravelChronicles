...
# Alles-in-einem Build-Script für Render mit verbesserten Funktionen
set -ex

echo "=== Komplettes Build-Script für Render mit Mobile UI ==="

# 1. Pakete installieren
echo "Installiere benötigte Pakete..."
npm install express pg multer sharp fs-extra

# 2. Einmal Datenbank-Setup ausführen
echo "Führe Datenbank-Setup aus (erstellt Tabelle neu)..."
