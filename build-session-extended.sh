...
echo "Starte Build mit erweitertem Session-Handling, höherem Limit und besserer Fehlerbehandlung..."
...
cp session-extended-server.js dist/index.js
...
cat > dist/package.json << EOL
{
  ...
  "version": "1.0.0",
  "description": "Travel Map Application with Session Improvements",
  "main": "index.js",
  "type": "commonjs",
  "scripts": {
