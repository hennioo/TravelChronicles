...
# Build-Skript für Version mit erweitertem Fehlerhandling und höherem Limit
echo "Starte Build mit 10MB Bildlimit und detailliertem Fehlerhandling..."
...
cp high-limit-server.js dist/index.js
...
cat > dist/package.json << EOL
{
  ...
  "version": "1.0.0",
  "description": "Travel Map Application with Higher Upload Limits",
  "main": "index.js",
  "type": "commonjs",
  "scripts": {
