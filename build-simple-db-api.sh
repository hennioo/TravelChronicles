...
# Build-Skript für verbesserte DB-API 
echo "Starte Build mit Bildkompression und erweitertem Fehlerhandling..."

# NPM-Pakete installieren
npm install express pg multer sharp dotenv cookie-parser
...
cp simple-db-api.js dist/index.js
