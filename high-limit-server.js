// Version mit höherem Upload-Limit (10MB)
...
const MAX_FILE_SIZE = 10 * 1024 * 1024; // 10MB statt 2MB
    ...
    <body>
      ...
      <script>
        ...
        function validateImageFile(file) {
          ...
          const maxSizeBytes = ${MAX_FILE_SIZE}; // 10 MB
          if (file.size > maxSizeBytes) {
            return {
              valid: false,
              message: 'Das Bild ist zu groß (max. 10 MB erlaubt)'
            };
          }
...
const upload = multer({
  storage: storage,
  limits: { fileSize: MAX_FILE_SIZE } // Erhöhtes Limit auf 10MB
});
